...
class Mode(Protocol):
    ...
    def wants_release(self) -> bool:
        """Режим повідомляє, що закінчив, але не звільняє екран сам.

        Рішення про те, хто займає екран, лишається за координатором:
        режим не може знати, чи не важливіше зараз щось інше.
        """
        ...
