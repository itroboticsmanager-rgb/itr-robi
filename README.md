...
- NFC-зона в правому боковому модулі; передача посилання на телефон через динамічну мітку з I²C (`D-005`, `D-036`).
...
- [Журнал рішень](docs/decisions.md) — **починайте звідси.** 38 записів, з них 6 відкритих.
